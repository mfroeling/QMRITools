...
"QMRIToolsFunctions[] give list of all the QMRITools functions."
...
QMRIToolsFunctions[toolb_String]:= Module[{packages,names,functions,options,allNames},
...
QMRIToolsFunctions[toolb_String,p_Integer]:=Block[{toolbox,functions,options},
