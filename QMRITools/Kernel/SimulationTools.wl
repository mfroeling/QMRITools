...
"GetPulseProfile[excitation, refocus] gives the pusl angle profiles for the excitation and refocusing pulses.
...
excitation and refocus are generated by GetPulseProfiel."
...
CreateDiffData::eig = "eigen system must be 3 eigenvalues {l1,l2,l2} in which cases fixed vectors wil be used 
	...
	other possibility is 3 eigenvalues with a random, randomz or random orthogonal (fixed vectors with random sign)
		{{l1,l2,l3},Random}
		{{l1,l2,l3},RandomZ}
		{{l1,l2,l3},OrtRandom}
	not : `1`"
