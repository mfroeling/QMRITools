...
FindMiddle::usage=
"FindMiddle[data] find the center of a two leg data.
FindMiddle[data, what] find the center of the data for the anatomy defined by what."
...
DataToVector[dataIn_, maskIn_] := Module[{data, sp, mask, depthDat, depthMask, depth, dimMask, dimDat},
