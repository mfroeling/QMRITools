...
GfactorSimulation[sensitivity_, W_, {dir1_, sensea_?ListQ}, {dir2_, senseb_?ListQ}, OptionsPattern[]] := Block[{
  ...
  dir = SortBy[{{dir1, sensea}, {dir2, senseb}}, First];
  ...
  If[OptionValue[GOutput] === "Grid",
   gfactorsAX = GridDataPlot[gfactors, Length[sense2]];
   gfactorsCOR = GridDataPlot[Transpose[Reverse@#, {2, 1, 3}] & /@ gfactors, Length[sense2]];
   gfactorsSAG = GridDataPlot[Transpose[Reverse@#, {3, 2, 1}] & /@ gfactors, Length[sense2]];
...
Options[CalculateGfactori] = {GRegularization -> 0.};
