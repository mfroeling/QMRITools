...
VerificationTest[(* 2 *)
	CompoundExpression[Set[pac, PacletInformation[First[PacletFind["QMRITools"]]]], Set[pacT, Or[SameQ[pac, List[Rule["Name", "QMRITools"], Rule["Version", "2.0.1"], Rule["BuildNumber", ""], Rule["Qualifier", ""], Rule["WolframVersion", "11.0+"], Rule["SystemID", All], Rule["Description", "Toolbox for Qunatitative MRI."], Rule["Category", ""], Rule["Creator", "Martijn Froeling <m.froeling@gmail.com>"], Rule["Publisher", ""], Rule["Support", ""], Rule["Internal", False], Rule["Location", StringJoin[$UserBaseDirectory, "\\Applications\\QMRITools"]], Rule["Context", List["QMRITools`"]], Rule["Enabled", True], Rule["Loading", Manual]]], SameQ[pac, List[Rule["Name", "QMRITools"], Rule["Version", "2.0.1"], Rule["BuildNumber", ""], Rule["Qualifier", ""], Rule["WolframVersion", "11.0+"], Rule["SystemID", All], Rule["Description", "Toolbox for Qunatitative MRI."], Rule["Category", ""], Rule["Creator", "Martijn Froeling <m.froeling@gmail.com>"], Rule["Publisher", ""], Rule["Support", ""], Rule["Internal", False], Rule["Location", StringJoin[$BaseDirectory, "\\Applications\\QMRITools"]], Rule["Context", List["QMRITools`"]], Rule["Enabled", True], Rule["Loading", Manual]]]]]]
	,
	True	
]
